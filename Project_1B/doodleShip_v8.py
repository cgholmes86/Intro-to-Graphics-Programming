...
class Ship(pygame.sprite.Sprite):
    ...
    def checkKeys(self):
        ...
        if keys[pygame.K_SPACE]:
            if self.firedelay == 0:                
                self.shells[self.shellcount].x = self.rect.centerx
                self.shells[self.shellcount].y = self.rect.centery
                self.shells[self.shellcount].speed = self.charge
                self.shells[self.shellcount].dir = self.dir
                self.shells[self.shellcount].inflight = True
                self.shellcount += 1
                self.firedelay += 3
            else: 
                self.firedelay -= 1
                ...
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_ESCAPE:
                        ...
                        for shell in ship_bullets:                        
                            shells[bulletcount].x = ship.rect.centerx
                            shells[bulletcount].y = ship.rect.centery
                            shells[bulletcount].speed = charge
                            shells[bulletcount].dir = dir
...
def splashScreen():
    ...
    splashbg = pygame.image.load("Assets/Images/splash.png")
    font = pygame.font.SysFont("Comic Sans MS", 36)

    pygame.mixer.music.load("Assets/Sound/ship_hit.ogg")
    pygame.mixer.music.play()

    screen.blit(splashbg,(0,0))
    loadingtext = font.render("Loading...", 1, (0,0,0))
    screen.blit(loadingtext, (130,220))
    pygame.display.flip()
