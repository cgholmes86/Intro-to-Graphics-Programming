...
#The 14 possible locations the player can go to set up in an array
...
def playerMove():
    ...
    while move !='1' and move !='2':
        ...
        move = int(raw_input())
        i = move
        #for loop to determine which number in the array to associate with new playerPosition
...
def chooseMove(playerPosition):
    ...
    #All of the possible player positions and options for continuing the story
